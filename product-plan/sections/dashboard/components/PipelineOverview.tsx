...
interface PipelineOverviewProps {
  ...
  onColumnClick?: (status: 'scheduled' | 'queue' | 'inProgress' | 'done') => void
  onViewAll?: () => void
}

const columns: { key: keyof PipelineStatus; label: string; accent: string; barColor: string }[] = [
  {
    key: 'scheduled',
    label: 'Scheduled',
...
export function PipelineOverview({ pipeline, onColumnClick, onViewAll }: PipelineOverviewProps) {
